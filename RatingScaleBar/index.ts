...
export class RatingScaleBar implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public init(
        ...
        this.value = context.parameters.value.raw ?? context.parameters.defaultValue.raw ?? 0;
    }
